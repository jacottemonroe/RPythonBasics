...
class building:
  ...
  def print(self):
    print(self.name + " is a building that is located at x: "
      + str(self.coordinates["x"]) + " y: " + str(self.coordinates["y"]))
...
Aurora = purposeBuilding(name="Aurora", coordinates={"x": 5.657, "y": 51.982}, purpose="eduction")
Gaia.print()
Aurora.print()
```
...
class purposeBuilding(building):
  ...
  def print(self):
    print(self.name + " is an " + self.purpose + " building that is located at x: "
      + str(self.coordinates["x"]) + " y: " + str(self.coordinates["y"]))
...
Another difference between R and Python you may also have noticed in the examples above: R uses curly braces `{}` to denote scope, whereas Python uses a colon `:` and enforces whitespace. As an example:
